...
\begin{proposition}[ (wth Alex Kruckman)]\label{prop_coalese}\ 
...
It would be interesting to separate $G^1$ from $G^{00}$ and understand its relations with $G^{000}$ as definitioned in Section~\ref{connected}.
